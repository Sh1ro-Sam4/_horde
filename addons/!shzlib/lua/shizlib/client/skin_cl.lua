...
local function updateColors()
	...
	if colBg == toBg and colG == toG then
		return hook.Remove('Think', 'shizlib.skinColors')
	end
...
function shizlib.changeSkinColor(bgColor, gColor, delta)
	...
	hook.Add('Think', 'shizlib.skinColors', updateColors)
end

surface.CreateFont('shz-icons', {
	font = 'FontAwesome',
	extended = true,
	size = 13,
	weight = 400,
...
function SKIN:PaintSliderKnob( pnl, w, h )
	...
	if pnl:GetDisabled() then
		return draw.SimpleText(utf8.char(0xf111), 'shz-icons', w/2, h/2, cols.dsb, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	elseif pnl.Depressed or pnl.Hovered then
		return draw.SimpleText(utf8.char(0xf111), 'shz-icons', w/2, h/2, cols.g, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	else
		draw.SimpleText(utf8.char(0xf111), 'shz-icons', w/2, h/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
...
function SKIN:PaintButtonDown( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf078), 'shz-icons2', w/2, h/2-1, col, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function SKIN:PaintButtonUp( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf077), 'shz-icons2', w/2, h/2-1, col, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function SKIN:PaintButtonLeft( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf053), 'shz-icons2', w/2, h/2-1, col, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function SKIN:PaintButtonRight( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf054), 'shz-icons2', w/2, h/2-1, col, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function SKIN:PaintMenuOption( pnl, w, h )
	...
	if pnl:GetChecked() then
		draw.SimpleText(utf8.char(0xf00c), 'shz-icons2', 16, h/2, Color(255,255,255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		-- draw.RoundedBox(4, 0, 0, w, h, cols.o)
	end
...
function SKIN:PaintMenuRightArrow( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf054), 'shz-icons3', w-5, h/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function SKIN:PaintExpandButton( pnl, w, h )
	...
	if pnl:GetExpanded() then
		draw.SimpleText(utf8.char(0xf111), 'shz-icons', w/2, h/2, color_black, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText(utf8.char(0xf056), 'shz-icons', w/2, h/2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	else
		draw.SimpleText(utf8.char(0xf111), 'shz-icons', w/2, h/2, cols.bg, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText(utf8.char(0xf055), 'shz-icons', w/2, h/2, Color(255,255,255, 80), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
...
function SKIN:PaintComboDownArrow( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf078), 'shz-icons', w/2, h/2, Color(0,0,0, 120), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
function SKIN:PaintNumberUp( pnl, w, h )
	...
	draw.SimpleText(utf8.char(0xf077), 'shz-icons3', w/2, h/2, Color(30,30,30), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)

end

function SKIN:PaintNumberDown( pnl, w, h )

	draw.SimpleText(utf8.char(0xf078), 'shz-icons3', w/2, h/2, Color(30,30,30), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
if skin then
	...
	derma.DefineSkin('shizlib', 'shz skin', SKIN)
end

hook.Add('ForceDermaSkin', 'shz-skin', function()
