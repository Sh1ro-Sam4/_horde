...
function PANEL:Init()
	...
	self.btnGrip = vgui.Create("SHZScrollBarGrip", self)
...
function PANEL:OnMouseWheeled(dlta)
    ...
    surface.PlaySound(snd.scrollWheeled)
...
function PANEL:Paint(w, h)
    ...
    draw.RoundedBox(self.btnGrip.BarScale, w - self.btnGrip.BarScale, 0, self.btnGrip.BarScale, h, ColorAlpha(col.accent, self.BackgroundOpacity))
    return true
end
...
derma.DefineControl('SHZScrollBar', '', PANEL, 'DPanel')