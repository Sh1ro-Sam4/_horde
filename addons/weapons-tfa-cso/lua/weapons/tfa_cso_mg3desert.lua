...
SWEP.PrintName				= "MG3 Desert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 1050					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 1050					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg3desert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg3desert.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.1, -2, 1.8)
SWEP.IronSightsAng = Vector(-10, -1.5, -3.855)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg3desert")
