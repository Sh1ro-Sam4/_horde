...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Zongzi"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_zongzi.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_zongzi.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("zongzi")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_zongzi")
