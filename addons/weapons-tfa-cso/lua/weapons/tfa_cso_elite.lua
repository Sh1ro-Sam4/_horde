...
SWEP.PrintName				= "Beretta 92G Elite II"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Elite.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread		= .0046					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0023	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_elite.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_elite_right.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["otherpist"] = { type = "Model", model = "models/weapons/tfa_cso/w_elite_left.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(5.479, 1.512, 3.155), angle = Angle(0, 75.515, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_elite")
