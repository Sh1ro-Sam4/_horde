...
SWEP.PrintName				= "Battle USP45"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.KickDown			= 0.132					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.132				-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_busp45.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_busp45.mdl" -- Worldmodel path
...
SWEP.WElements = {
    ["silencer"] = { type = "Model", model = "models/weapons/tfa_cso/w_busp45_silencer.mdl", bone = "models/weapons/tfa_cso/w_usp.mdl", rel = "", pos = Vector(-0.15, 7.80, 0.85), angle = Angle(0, 0, 00), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_busp")
