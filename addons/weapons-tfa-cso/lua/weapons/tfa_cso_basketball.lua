...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Basketball Grenade"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_basketball.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_basketball.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("basketball_nade")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 1400 -- Entity Velocity
SWEP.Velocity_Underhand = 700 -- Entity Velocity
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_basketball")
