...
SWEP.PrintName				= "Barrett M95 Desert"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp			= 0.675				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.675					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m95desert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m95desert.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m95desert")
