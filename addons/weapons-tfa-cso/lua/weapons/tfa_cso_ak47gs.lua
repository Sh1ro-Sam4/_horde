...
SWEP.PrintName				= "AK-47 10th Anniversary"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47gs.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47gs.mdl" -- Worldmodel path
