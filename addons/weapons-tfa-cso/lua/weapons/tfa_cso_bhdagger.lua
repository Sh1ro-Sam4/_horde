...
SWEP.PrintName = "Battle Hunting Dagger"
SWEP.Author	= "Kamikaze" --Author Tooltip
SWEP.ViewModel = "models/weapons/tfa_cso/c_bhdagger.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		['len'] = 55, -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bhdagger")
