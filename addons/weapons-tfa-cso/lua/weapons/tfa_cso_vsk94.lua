...
SWEP.PrintName				= "VSK-94"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("VSK.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Crappy Sniper MachineGun"
...
SWEP.Primary.IronAccuracy = .00045	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_vsk94.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_vsk94.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(9.482, -6.494, 1.93)
SWEP.IronSightsAng = Vector(0, 0, 0)

--[[INSPECTION]]--

SWEP.InspectPos = Vector(-3,-10,-1) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(18,-42,-5) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_vsk94")
