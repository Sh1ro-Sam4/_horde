...
SWEP.PrintName				= "Battle FAMAS F1"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bfamas.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bfamas.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bfamas")
