...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Water Balloon"		-- Weapon name (Shown on HUD)	
...
SWEP.InspectPos = Vector(-2,-2,0) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(0,-16,0) --Replace with a vector, in style of ironsights angle, to be used for inspection
SWEP.InspectionLoop = true --Setting false will cancel inspection once the animation is done.  CS:GO style.

SWEP.ProceduralHolsterTime = 0
SWEP.ViewModelFOV			= 80
SWEP.ViewModelFlip			= true
SWEP.ViewModel				= "models/weapons/tfa_cso/c_waterballoon.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_waterballoon.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("waterballoon")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_waterballoon")
