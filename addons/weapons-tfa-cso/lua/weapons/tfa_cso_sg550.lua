...
SWEP.PrintName				= "SIG SG550 Sniper"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SG550.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .00070	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sg550.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sg550.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.756, -5.521, 2.327)
SWEP.IronSightsAng = Vector(-1.197, 0.007, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sg550")
