...
SWEP.Attachments = {
    [1] = { atts = { "cso_deaglechoijiyoon","cso_deagleeagle","cso_deaglegalaxy","cso_deagleindonesia","cso_deaglepaint1","cso_deaglepaint2","cso_deaglepaint3","cso_deaglepaintwood" } },
}
