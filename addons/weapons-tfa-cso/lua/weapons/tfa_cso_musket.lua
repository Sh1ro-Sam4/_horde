...
--Firing related
SWEP.Primary.Sound 			= Sound("Musket.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_musket.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_musket.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.044, 0, 0.852)
SWEP.IronSightsAng = Vector(-2.27, 2.86, -6.435)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_musket")
