...
SWEP.PrintName				= "Battle QBB-95"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Qbb95.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.SpreadIncrement = 0.65 --What percentage of the modifier is added on, per shot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bqbb95.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bqbb95.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.335, 0, 0.255)
SWEP.IronSightsAng = Vector(0, 0.075, 0)

--[[INSPECTION]]--

SWEP.InspectPos = Vector(-4,-5,-1) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(20,-55,-5) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bqbb95")
