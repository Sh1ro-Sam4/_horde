...
SWEP.PrintName				= "Bear Fury MK-2"		-- Weapon name (Shown on HUD)	
...
SWEP.ProjectileEntity = "bearfurymk2" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bearfurymk2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bearfurymk2_right.mdl" -- Worldmodel path
...
SWEP.WElements = {
    ["bearfurymk2_l"] = { type = "Model", model = "models/weapons/tfa_cso/w_bearfurymk2_left.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(0, -1, 0), angle = Angle(0, 85, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
    ["jetpack"] = { type = "Model", model = "models/weapons/tfa_cso/w_bearfurymk2_jetpack.mdl", bone = "ValveBiped.Bip01_Spine2", rel = "", pos = Vector(5, 7, 0), angle = Angle(90, 90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Secondary.Sound = Sound("BearFuryMK2.Dash")
SWEP.Secondary.ClipSize			= -1					-- Size of a clip
SWEP.Secondary.DefaultClip			= 0					-- Default ammo to give...
SWEP.Secondary.Automatic			= false					-- Automatic/Semi Auto
SWEP.Secondary.Ammo			= "bearjumpmk2" -- Self explanitory, ammo type.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bearfurymk2")
