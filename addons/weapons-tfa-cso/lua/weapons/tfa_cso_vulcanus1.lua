...
SWEP.PrintName				= "VULCANUS-1"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.SilencedSound  = Sound("VULCANUS1.FireB") -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage_Regular		= 38					-- Damage, in standard damage points.
SWEP.Primary.Damage		= SWEP.Primary.Damage_Regular
SWEP.Primary.Damage_Secondary		= 56					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_vulcanus1.mdl" --Viewmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_vulcanus1")
...
function SWEP:Initialize()
	...
	self.StatCache_Blacklist["DoMuzzleFlash"] = true
...
function SWEP:Think2(...)
	if self:GetStatus() == TFA.Enum.STATUS_SILENCER_TOGGLE and self:GetStatusEnd() <= CurTime() then
		...
		if self:GetSilenced() then
            ...
            self.Primary_TFA.KickDown = 0.125				
            self.Primary_TFA.KickHorizontal	= 0.175
