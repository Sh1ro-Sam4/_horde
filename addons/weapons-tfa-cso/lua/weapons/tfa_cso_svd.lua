...
SWEP.PrintName				= "Dragunov SVD"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SVD.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Dum Dum Dum Dum"
...
SWEP.Primary.IronAccuracy = .00060	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_svd.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_svd.mdl" -- Worldmodel path
...
SWEP.ScopeScale = .8 --Scale of the scope overlay
SWEP.ReticleScale = .8 --Scale of the reticle overlay
...
SWEP.IronSightsPos = Vector(8.287, -4.184, 1.518)
SWEP.IronSightsAng = Vector(0, 0, 1.35)

--[[INSPECTION]]--

SWEP.InspectPos = Vector(-5,-9,-1) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(15,-40,-5) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_svd")
