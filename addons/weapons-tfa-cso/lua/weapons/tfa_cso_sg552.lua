...
--Firing related
SWEP.Primary.Sound 			= Sound("SG552.Fire")				-- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.195					-- This is the maximum upwards recoil (rise)
...
SWEP.Primary.IronAccuracy = .0018375	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sg552.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sg552.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(6.65, -4.56, 1.518)
SWEP.IronSightsAng = Vector(0.456, 0.151, 0)
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sg552")
