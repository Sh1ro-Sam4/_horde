...
SWEP.PrintName				= "Dual Infinity Final Desert"		-- Weapon name (Shown on HUD)	
...
SWEP.NZPaPName				= "Infinite Desert"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_infinityex2desert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_infinityex2desert_right.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["otherpist"] = { type = "Model", model = "models/weapons/tfa_cso/w_infinityex2desert_left.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.479, 1.812, 2.755), angle = Angle(0, 75.515, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_infinityex2desert")
