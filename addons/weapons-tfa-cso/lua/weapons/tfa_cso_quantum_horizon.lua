...
SWEP.PrintName				= "Quantum Horizon"		-- Weapon name (Shown on HUD)
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_quantum_horizon.mdl" -- Worldmodel path
...
SWEP.TracerName 		= "tra_quantum" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_quantum_horizon")
