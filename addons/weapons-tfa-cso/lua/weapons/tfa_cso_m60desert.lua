...
SWEP.PrintName				= "M60E4 Desert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Spread		= .0036					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0009	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m60desert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m60desert.mdl" -- Worldmodel path
...
SWEP.ScopeOverlayThreshold = 0.95 --Percentage you have to be sighted in to see the scope.
...
SWEP.IronSightsAng = Vector(-8.35, 3.4, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m60desert")
