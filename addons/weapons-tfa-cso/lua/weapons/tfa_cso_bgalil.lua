...
SWEP.PrintName				= "Battle Galil"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Galil.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bgalil.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
    ["ValveBiped.Bip01_R_Forearm"] = { scale = Vector(0.85, 0.75, 0.75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
    ["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(0.85, 0.75, 0.75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
    ["ValveBiped.Bip01_R_Hand"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
    ["ValveBiped.Bip01_L_Hand"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_bgalil.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.015, 0, 1.415)
SWEP.IronSightsAng = Vector(0.085, 0.012, 0)
...
SWEP.BlowbackBoneMods = {
	["Bone07"] = { scale = Vector(1, 1, 1), pos = Vector(0, 2, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bgalil")
