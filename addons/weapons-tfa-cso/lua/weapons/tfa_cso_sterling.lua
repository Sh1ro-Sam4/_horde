...
SWEP.PrintName				= "Sterling L2A3"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sterlingbayonet.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sterlingbayonet.mdl" -- Worldmodel path
...
SWEP.RunSightsPos = Vector( -2, -10, -5)
...
SWEP.IronSightsAng = Vector(0.2, -0.15, 0)

--[[INSPECTION]]--

SWEP.InspectPos = Vector( -2, -10, -5) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector( 50, -10, 0)--Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sterling")
