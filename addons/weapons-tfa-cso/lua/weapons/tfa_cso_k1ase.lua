...
SWEP.PrintName				= "Daewoo K1A Special Edition"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("K1ASE.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_k1ase.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_k1ase.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_k1ase")
