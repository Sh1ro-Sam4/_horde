...
SWEP.PrintName				= "M249 Ra"		-- Weapon name (Shown on HUD)
...
SWEP.Type	= "Unique Grade Machine Gun"
...
--Firing related
SWEP.Primary.Sound 			= Sound("M249Ra.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m249ra.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m249ra.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_m249ra" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_m249ra" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("M249Ra.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m249ra")
	SWEP.DrawWeaponSelection = TFA_CSO_DrawWeaponSelection
end

SWEP.Secondary.ClipSize = -1
SWEP.Secondary.DefaultClip = 0
SWEP.Secondary.Ammo = "uraeus"
SWEP.Secondary.Automatic = true
SWEP.Secondary.Ent = "m249ra_fireball"
SWEP.Secondary.Nextregen = 0
SWEP.Secondary.MaxAmmo = 5
SWEP.Secondary.Model = "models/hunter/misc/sphere1x1.mdl" --Projectile Model
SWEP.Secondary.Damage = 3000 --Grenade Damage
SWEP.Secondary.Velocity = 1500 --Grenade Velocity
SWEP.Secondary.Delay = 0.5 --Delay in seconds
SWEP.Secondary.Sound = Sound("M249Ra.Fire2") --Firing sound
...
function SWEP:Think() 
if SERVER then
if self.Secondary.Nextregen <= CurTime()  and self:Ammo2() < 5 then 
self.Owner:GiveAmmo( 1,"uraeus", true )                     -------SECONDARY AMMO REGEN
...
function SWEP:SecondaryAttack()
	if CurTime() >  self:GetNextPrimaryFire() and TFA.Enum.ReadyStatus[ self:GetStatus() ] and not self:GetSprinting() and self:Ammo2() > 0 then
		...
		self.Secondary.Nextregen = CurTime() + 4.5
