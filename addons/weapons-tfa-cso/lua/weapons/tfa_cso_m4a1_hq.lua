...
SWEP.PrintName				= "M4A1 Camouflage"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m4a1_hq.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m4a1_hq.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.77, -1, 2.069)
SWEP.IronSightsAng = Vector(2.082, 1.052, 8.175)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m4a1_hq")
