...
SWEP.PrintName				= "Daewoo K1A"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("K1A.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Korean Special SMG"
...
SWEP.Primary.IronAccuracy = .00322	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_k1a.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_k1a.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.765, 0, 1.65)
SWEP.IronSightsAng = Vector(0.25, 0.025, 0)

--[[INSPECTION]]--

SWEP.InspectPos = Vector(-4,-6,-1) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(15,-45,-5) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_k1a")
