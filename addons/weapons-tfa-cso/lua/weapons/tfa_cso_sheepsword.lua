...
SWEP.PrintName = "Horn Kujang"
SWEP.Author	= "Kamikaze" --Author Tooltip
SWEP.Type	= "Melee weapon"
SWEP.ViewModel = "models/weapons/tfa_cso/c_sheepsword.mdl"
SWEP.WorldModel = "models/weapons/tfa_cso/w_sheepsword.mdl"
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sheepsword")
