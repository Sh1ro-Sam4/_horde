...
SWEP.PrintName				= "Kingdom Bow"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 70 --effective damage				-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Hunting Bow"
SWEP.NZPaPReplacement 	= "tfa_cso_bow"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_kingdombow.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
	["bow_bone05"] = { scale = Vector(1, 1, 1), pos = Vector(2, 0, 0), angle = Angle(0, 0, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_kingdombow.mdl" -- Weapon world model path
...
SWEP.TracerName 		= "tra_kingbow" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_kingdombow")
