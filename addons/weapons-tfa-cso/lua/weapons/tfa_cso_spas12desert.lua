...
SWEP.PrintName				= "SPAS-12 Desert"		-- Weapon name (Shown on HUD)
...
SWEP.IronSightTime = 0.0 --The time to enter ironsights/exit it.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_spas12desert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_spas12desert.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_spas12desert")
