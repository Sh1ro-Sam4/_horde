...
function EFFECT:Render()
	...
	render.SetMaterial(Material("sprites/starchaser_star"))
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.5, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	render.SetMaterial(Material("sprites/starchaser_tracer"))
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - -0.5, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.025, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.05, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.075, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.1, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.125, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.15, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.175, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.2, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.225, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.25, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.275, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 60)
	tracerpos = Lerp(math.Clamp(self.LifeTime / self.Life - 0.3, 0, 1), endPos, startPos)
	render.DrawQuadEasy(tracerpos, self.Normal, 32, 32, beamcol2, self.rot - 30)
end
