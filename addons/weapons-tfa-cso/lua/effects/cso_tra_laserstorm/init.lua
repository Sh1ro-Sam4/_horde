...
local Mat_Impact = Material("tracers/ef_y23s1sfsmg_laser_hit")
local Mat_Beam = Material("tracers/ef_y23s1sfsmg_laser")
...
function EFFECT:Render()
	...
	render.DrawSprite(endPos, 16, 16, Color(255, 255, 255, 255))
