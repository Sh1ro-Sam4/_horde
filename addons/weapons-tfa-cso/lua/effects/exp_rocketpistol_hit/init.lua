EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_rocketpistol_hit2")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/rocketpistol/exp2.wav", 256 )
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 96, 96, Color(255, 255, 255, 255))
end