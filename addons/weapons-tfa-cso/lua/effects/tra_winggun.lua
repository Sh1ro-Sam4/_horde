...
function EFFECT:Render()
	...
	for i = 0, nlen * (1 - delta), 32 do
		...
		render.DrawBeam(prevspinpos, spinbeampos, 12, texcoord + i, texcoord + 1 + i, Color(255,255,255, self.Color.a))
		render.DrawBeam(prevspinpos2, spinbeampos2, 12, texcoord + i, texcoord + 1 + i, Color(255,255,255, self.Color.a))
