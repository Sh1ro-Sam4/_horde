...
local color1 = Color( 255, 178, 255, 255 )
local color2 = Color( 255, 68, 243, 255 )
...
function EFFECT:Init(data)
	...
	if (sparticle) then
		...
		sparticle:SetColor(255, 178, 255)
