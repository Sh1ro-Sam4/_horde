...
local Mat_Impact = Material("sprites/ef_revivegun_expB")
local Mat_Beam = Material("sprites/ef_revivegun_laser")
...
function EFFECT:Render()
	...
	render.DrawSprite(endPos, 64, 64, Color(255, 255, 255, 255))
