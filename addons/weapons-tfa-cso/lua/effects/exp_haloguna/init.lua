EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_halogun_expA")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/halogun/exp2.wav", 512 )
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 25), 0, 25))
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 192, 192, Color(255, 255, 255, 255))
end