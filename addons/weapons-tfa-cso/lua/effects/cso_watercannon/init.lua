...
local PerfIndex = GetConVar("cso_watercannon_fx"):GetInt()
...
if data:GetEntity():IsValid() && StartPos && HitPos then
	...
	local FlameEmitter = ParticleEmitter(StartPos)
		...
		for i=0, 8 do
			...
			local FlameMat = {}
			FlameMat[1] = "sprites/holybomb_sprite"
			FlameMat[2] = "sprites/holybomb_sprite"
			FlameMat[3] = "sprites/holybomb_sprite"
