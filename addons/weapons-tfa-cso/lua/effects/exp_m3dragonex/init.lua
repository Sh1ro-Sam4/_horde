EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_m3dragonex_bomb")
EFFECT.g_sModelIndexFireball2 = Material("sprites/ef_m3dragonex_exp0"..math.random(1,3))
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/sg552_cerberus/claw.wav", 100 )
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball2:SetInt("$frame", math.Clamp(math.floor(self.Frame * 20), 0, 20))
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 256, 256, Color(255, 255, 255, 255))
end