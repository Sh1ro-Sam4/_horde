EFFECT.g_sModelIndexFireball3 = Material("sprites/thanatos1_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/thanatos11/exp.wav", 512 )
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 30), 0, 15))
