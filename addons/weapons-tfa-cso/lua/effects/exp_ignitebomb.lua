EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_ignite_bomb_fire")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/ignitebomb/exp.wav", 512 )
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 10), 300, 300, Color(255, 255, 255, 255))
end