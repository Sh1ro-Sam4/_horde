EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_lockongunma_explosion")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/lockongunma/exp.wav", 512 )
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 35), 0, 35))
