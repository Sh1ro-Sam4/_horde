EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_y22s2lunarcannon_moon_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/lunarcannon/exp.wav", 512 )
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 10), 384, 384, Color(255, 255, 255, 255))
end