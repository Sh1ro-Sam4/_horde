...
local Mat_Impact = Material("tracers/colflare_keeper")
local Mat_Beam = Material("tracers/lightning_keeper")
...
local beamcol = Color(225, 255, 0, 255)
local beamcol2 = Color(225, 255, 0, 255)
...
function EFFECT:Render()
	...
	render.DrawBeam(startPos, endPos, self.Thickness, 0 + beamcol.a / 64, endPos:Distance(startPos) / 64, Color(225, 255, 0, 255))
end
