EFFECT.g_sModelIndexFireball3 = Material("sprites/heavenscorcher_exp2")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/heaven_scorcher/mine_exp.wav", 512 )
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 38), 0, 38))
