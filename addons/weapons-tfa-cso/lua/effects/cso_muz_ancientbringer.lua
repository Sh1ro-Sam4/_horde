...
local color1 = Color( 50, 210, 40, 255 )
local color2 = Color( 97, 255, 166, 255 )
...
function EFFECT:Init(data)
	...
	for i = 0, sparkcount do
		...
		if (particle) then
			...
			particle:SetEndAlpha(0)
			particle:SetStartSize(.35)
			particle:SetEndSize(1.05)
			particle:SetRoll(math.rad(math.Rand(0, 360)))
			particle:SetGravity(Vector(0, 0, -50))
			particle:SetAirResistance(40)
			particle:SetStartLength(0.1)
			particle:SetEndLength(0.05)
			particle:SetColor(78, 220, 255)
			particle:SetVelocityScale(true)
