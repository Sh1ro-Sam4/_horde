...
function EFFECT:Init(data)
	...
	self.Color = Color(255, 255, 153)
	self.LifeTime = 0.3 + 0.013 * ((self.StartPos - self.EndPos):Length() ^ 0.2) -- Keep the particle relatively constant speed
...
function EFFECT:Render()
	...
	for i = 0, nlen * (1 - delta), 32 do
		...
		render.DrawBeam(prevspinpos, spinbeampos, 12, texcoord + i, texcoord + 1 + i, Color(54, 202, 255, self.Color.a))
		render.DrawBeam(prevspinpos2, spinbeampos2, 12, texcoord + i, texcoord + 1 + i, Color(82, 239, 255, self.Color.a))
