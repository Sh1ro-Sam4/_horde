EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_revivegun_expA")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/quantum_horizon/exp.wav", 100)
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 26), 0, 13))
