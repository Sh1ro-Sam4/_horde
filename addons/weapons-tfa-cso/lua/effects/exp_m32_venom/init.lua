EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_m32_poison")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/m32_venom/exp.wav", 512 )
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 160, 160, Color(255, 255, 255, 255))
end