EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_restrictionpistol_hit")
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 15), 0, 4))
