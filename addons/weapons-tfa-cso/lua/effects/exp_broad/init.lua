EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_broad2")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/broad/boom.wav", 512 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 16), 0, 16))
