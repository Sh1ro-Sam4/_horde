...
local Mat_Impact = Material("sprites/plasmagun_muzzleflash")
local Mat_Beam = Material("tracers/ef_halogun_projectile")
...
function EFFECT:Render()
	...
	render.DrawSprite(endPos, 0, 0, Color(120, 255, 255, 255))
