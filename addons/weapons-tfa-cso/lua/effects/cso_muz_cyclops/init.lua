...
function EFFECT:Init(data)
	...
	for i = 1, 1 do
		local particle = emitter:Add("sprites/ef_restrictionpistol_muzzleflash01", self.vOffset + dir * 0.4 * i + FrameTime() * AddVel)
		...
		if (particle) then
			...
			particle:SetRoll(math.rad(math.Rand(-10, 10)))
