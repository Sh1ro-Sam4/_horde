EFFECT.g_sModelIndexFireball3 = Material("sprites/ef_buffsg552ex_slash3")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/m3dragonex/charge_attack.wav", 100 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 19), 0, 19))
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 350, 350, Color(255, 255, 255, 255))
end