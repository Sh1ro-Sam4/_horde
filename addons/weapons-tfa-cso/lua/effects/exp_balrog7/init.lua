...
EFFECT.g_sModelIndexFireball2 = Material("sprites/spear_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/fragnade/exp" ..math.random(1,3) ..".wav", 512 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball2:SetInt("$frame", math.Clamp(math.floor(self.Frame * 21), 0, 21))
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 200, 200, Color(255, 255, 255, 255))
end