...
function EFFECT:Render()
	...
	for i = 0, nlen * (1 - delta), 32 do
		...
		render.DrawBeam(prevspinpos2, spinbeampos2, 12, texcoord + i, texcoord + 1 + i, Color(198,132,230, self.Color.a))
