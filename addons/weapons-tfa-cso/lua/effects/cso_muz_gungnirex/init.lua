...
function EFFECT:Init(data)
	...
	for i = 1, 1 do
		local particle = emitter:Add("sprites/ef_gungnirex_muzzleflash", self.vOffset + dir * 0.4 * i + FrameTime() * AddVel)
		...
		if (particle) then
			...
			particle:SetEndSize( 24 * (halofac*0.8+0.2), 0, 1)
			particle:SetRoll(math.rad(math.Rand(-360, 360)))
