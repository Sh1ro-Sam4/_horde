...
ATTACHMENT.Icon = "entities/att/cso_benditahighelf.png" -- icon
ATTACHMENT.ShortName = "High Elf" -- short name that displayed inside the icon

ATTACHMENT.WeaponTable = {
	MaterialTable = { -- materials that are present on both view- and worldmodel
	[1] = "models/weapons/tfa_cso/paint/benditahighelf_v",
	[2] = "models/weapons/tfa_cso/paint/benditahighelf_v_alpha",
},
--	 MaterialTable_V = {
