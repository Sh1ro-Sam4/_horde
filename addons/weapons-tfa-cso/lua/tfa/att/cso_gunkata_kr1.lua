...
ATTACHMENT.Icon = "entities/att/cso_gunkata_kr1.png" -- icon
...
ATTACHMENT.WeaponTable = { -- run lua_run PrintTable(Entity(1):GetActiveWeapon():GetMaterials()) in console command to get where texture part are located
	 MaterialTable_V = {
	 [1] = "models/weapons/tfa_cso/paint/gunkata_kr1/$20@004gunslingerkr1_v",
	 [2] = "models/weapons/tfa_cso/paint/gunkata_kr1/$20@004gunslingerkr1_v_gold",
	 [3] = "models/weapons/tfa_cso/paint/gunkata_cn1/$0b_gunkatafx01",
	 [4] = "models/weapons/tfa_cso/paint/gunkata_cn1/$0b_gunkatafx02",
	 [5] = "models/weapons/tfa_cso/paint/gunkata_kr1/$20@004gunslingerkr1_trail",
	...
	["MuzzleFlashEffect"] = "muz_gunkata_kr1",
}
