...
ATTACHMENT.Description = {TFA.AttachmentColors["+"],"x2.5 Damage"}
ATTACHMENT.Icon = "entities/att/cso_mp5gs.png" -- icon
ATTACHMENT.ShortName = "Gold Special" -- short name that displayed inside the icon

ATTACHMENT.WeaponTable = {
	MaterialTable = { -- materials that are present on both view- and worldmodel
	[1] = "models/weapons/tfa_cso/10th_anniversary_gold_special/$20@003mp5gs_v",
},
	["Primary"] = {
