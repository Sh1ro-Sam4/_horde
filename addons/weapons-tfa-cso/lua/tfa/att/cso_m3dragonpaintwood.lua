...
ATTACHMENT.Icon = "entities/att/cso_m3dragonpaintwood.png" -- icon
ATTACHMENT.ShortName = "Wood" -- short name that displayed inside the icon

ATTACHMENT.WeaponTable = {
	MaterialTable = { -- materials that are present on both view- and worldmodel
	[1] = "models/weapons/tfa_cso/paint/$20@001_buf_m3_paintwood_01",
	[2] = "models/weapons/tfa_cso/paint/$20@004_buf_m3_paintwood_02",
},
--	 MaterialTable_V = {
