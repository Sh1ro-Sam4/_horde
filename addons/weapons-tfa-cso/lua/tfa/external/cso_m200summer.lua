...
TFA.AddWeaponSound( "M200_Summer.Fire", "weapons/tfa_cso/summersplash/m200_fire.wav", false, "^" )
local hookName = "cso_m200summer" -- hook ID for patcher, make sure it's set to something unique!

local patchTbl = {
	["cso_m200summer"] = { -- class of weapon you want to patch skins in
		[1] = { -- SWEP.Attachments table index/category
			"cso_m200summer", -- list of attachment IDs (lua/tfa/att/<attachment id>.lua) you want to patch in, comma-separated
		},
	},
}
