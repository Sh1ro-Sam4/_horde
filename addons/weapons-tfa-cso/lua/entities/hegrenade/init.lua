...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/tfa_cso/w_hegrenade.mdl")
	...
	self:SetAngles(Angle(0, 0, 0) + self.Owner:EyeAngles())
...
function ENT:Explosion()
	...
	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 256, 180)
