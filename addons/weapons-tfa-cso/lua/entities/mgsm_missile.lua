ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "M2 Devastator missile"
ENT.Category		= "None"
...
ENT.MyModel = "models/weapons/tfa_cso/w_mgsm_missile.mdl"
ENT.MyModelScale = 1
ENT.Damage = 8000
ENT.Radius = 250
if SERVER then
	...
	function ENT:Initialize()
		...
		local model = self.MyModel and self.MyModel or "models/weapons/tfa_cso/w_mgsm_missile.mdl"
	...
	function ENT:PhysicsCollide(data, physobj)
		...
		util.Effect("exp_mgsm",fx)
		self:Remove()
	end
	
	function ENT:Think()
		for key,thing in pairs(ents.FindInSphere(self:GetPos(),50))do
