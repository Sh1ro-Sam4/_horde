...
local function tfaOptionHUD(panel)
	...
	panel:CheckBox("#tfa.hudsettings.keybindhints.enabled", "cl_tfa_hud_keybindhints_enabled")
	panel:NumSlider("#tfa.hudsettings.keybindhints.solidtime", "cl_tfa_hud_keybindhints_solidtime", 0, 15, 3)
	panel:NumSlider("#tfa.hudsettings.keybindhints.fadeintime", "cl_tfa_hud_keybindhints_fadeintime", 0.01, 10, 3)
	panel:NumSlider("#tfa.hudsettings.keybindhints.fadeouttime", "cl_tfa_hud_keybindhints_fadeouttime", 0.01, 10, 3)
end
