...
-----------------------------------------------*/
ENT.Model = "models/spe.mdl" 
ENT.StartHealth = GetConVarNumber("vj_spezom_h")
...
ENT.UntilNextAttack_Melee = 0.4 -- How much time until it can use a attack again? | Counted in Seconds
ENT.AnimTbl_MeleeAttack = {"Attack1"} 
ENT.MeleeAttackDamage =  GetConVarNumber("vj_spezom_d")
...
ENT.SoundTbl_Pain = {"cszom/zombi_hurt_female_1.mp3","cszom/zombi_hurt_female_2.mp3"}
ENT.SoundTbl_Death = {"cszom/zombi_death_female_1.mp3","cszom/zombi_death_female_1.mp3"}
...
function ENT:CustomInitialize()
	self:SetCollisionBounds(Vector(21, 21, 60), Vector(-21, -21, 0))
