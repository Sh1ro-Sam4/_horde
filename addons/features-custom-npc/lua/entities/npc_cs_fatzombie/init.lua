...
-----------------------------------------------*/
ENT.Model = {"models/Heav.mdl","models/heav2.mdl"} 
 --ENT.Model = {"models/rhino_crypt.mdl"} 
 
ENT.StartHealth = GetConVarNumber("vj_fatzombie_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_fatzombie_d")
