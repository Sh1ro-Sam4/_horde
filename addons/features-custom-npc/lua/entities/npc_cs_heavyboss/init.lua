...
-----------------------------------------------*/
ENT.Model = "models/heavy_boss.mdl" 
ENT.StartHealth = GetConVarNumber("vj_heavyboss_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_heavyboss_d")
...
ENT.SoundTbl_Pain = {"cszom/zombi_hurt_01.mp3","cszom/zombi_hurt_02.mp3"}
