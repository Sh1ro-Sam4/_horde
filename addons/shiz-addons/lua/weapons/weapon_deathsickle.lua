...
SWEP.PrintName					= "Death Sickle"
SWEP.Instructions				= ""

SWEP.ViewModel 					= "models/weapons/c_emptycrowbar.mdl"
SWEP.ViewModelFlip				= false
SWEP.ShowWorldModel				= false
SWEP.WorldModel					= "models/death sickle/death_sickle.mdl"
...
SWEP.VElements = {
	["element_namebb"] = { type = "Model", model = "models/death sickle/death_sickle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.7, 1.557, -4.676), angle = Angle(-45.584, 0, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_nameaa"] = { type = "Model", model = "models/death sickle/death_sickle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(18.181, 1.557, 0), angle = Angle(-31.559, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	local pents = ents.FindInSphere(tr.start, self.Primary.Range / 2)
	local hitted = false
	...
	self.Weapon:EmitSound("Sickleslash")
	...
	if SERVER then
		local spell = ents.Create("ent_spinnydeathsickle")
		...
		spell:Spawn()
		spell:Activate()
		--util.SpriteTrail( spell.Entity, 2, Color( 22, 255, 22 ), false, 100, 0, 0.7, 1 / ( 50 + 1 ) * 0.5, "trails/laser.vmt" )
