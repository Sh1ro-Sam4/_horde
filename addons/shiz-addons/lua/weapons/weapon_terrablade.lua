...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/terra blade/terra_blade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(11.947, 3.635, -1.558), angle = Angle(-139.092, 164.804, -10.52), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/terra blade/terra_blade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(11.947, 4.675, -1.558), angle = Angle(-139.092, 162.468, -3.507), size = Vector(1, 1.08, 1), color = Color(255, 255, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		local spell = ents.Create("ent_terrasword")
		...
		spell:Spawn()
		spell:Activate()
		spell:SetColor( Color(0, 255, 0, 255))
