...
f4 = f4 or {}
f4.Colors = {
	background 		= Color(48,50,65,250),
	button_tab 		= Color(117, 156, 169, 160),
	background_hud 	= Color(107, 115, 118, 100),
	shop 			= Color(48,50,65,125),
	job 			= Color(161,104,255,5),
	panel			= Color(107, 115, 118, 100),
	top				= Color(38, 38, 38, 200),
	top_grad		= Color(38, 38, 38, 200),
	button			= Color(38, 38, 38, 200),
	close			= Color(239,231,255),
	close_hover		= Color(48,50,65),
	max				= Color(175,175,175),
	vip				= Color(255,208,108),
	battlepass		= Color(152,108,255),
	green			= Color(123,223,77),
	red				= Color(199,28,28),
	blue			= Color(28,102,199),
	orange			= Color(255,170,73),
	root 			= Color(255,0,0),
	license			= Color(147,107,27,200),
	arrest 			= Color(255,99,99),
}
...
function PANEL:Init()
    ...
    self.Send.Paint = function(s, w, h)
        local col = s.Hovered and color_white or f4.Colors.top
    ...
    self.Scroll.VBar.btnGrip.Paint = function(s, w, h)
        if self:IsKeyboardInputEnabled() then
            draw.RoundedBox(shizlib.surface.s(8),0,0,w,h,f4.Colors.top_grad)
        end
    end
...
function shizlib.openChatbox(bTeam)
    if LocalPlayer().ShowF4 or LocalPlayer().ShowTabs then return end
