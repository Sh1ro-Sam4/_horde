...
[7] = Color( 255, 22, 255 )
	...
	if( emitter ) then
		...
		for i = 1, 10 do
			...
			local particle = emitter:Add( "effects/ar2_altfire1b", self.Position + self.Normal * 2 );
			...
			particle:SetColor( Coloride[self.Color].r,Coloride[self.Color].g,Coloride[self.Color].b)
			particle:SetRoll( 0 );
