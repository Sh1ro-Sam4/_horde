...
local function CheckAllowFeature(ply)
...
hook.Remove("SpawnMenuOpen", "Horde_SpawnMenu", CheckAllowFeature)
...
function GM:PlayerSpawnVehicle(ply, model, name, table) return CheckAllowFeature(ply) end

function GM:PlayerSpawnSWEP(ply, weapon, info) return CheckAllowFeature(ply) end

function GM:PlayerSpawnSENT(ply, class) return CheckAllowFeature(ply) end

function GM:PlayerSpawnRagdoll(ply, model) return CheckAllowFeature(ply) end

function GM:PlayerSpawnProp(ply, model) return CheckAllowFeature(ply) end

function GM:PlayerSpawnObject(ply, model, skin) return CheckAllowFeature(ply) end

function GM:PlayerSpawnNPC(ply, npc_type, weapon) return CheckAllowFeature(ply) end

function GM:PlayerSpawnEffect(ply, model) return CheckAllowFeature(ply) end
